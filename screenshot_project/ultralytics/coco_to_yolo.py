    ...
    for image in images :
        ...
        for annot in annots :
            if annot['image_id'] == id :
                ...
                # coco양식 json파일의 category_id는 1부터 작성되어서 yaml형식과 맞춰주려면 -1의 작업이 필요하나 
                # 해당 annotation에서는 0을 공백으로 처리함
                x, y, w, h = annot['bbox']
                # 정규화까지 진행
...
train_path = "./screenshot_project/screenshot_dataset/train/"
valid_path = "./screenshot_project/screenshot_dataset/valid/"
test_path = "./screenshot_project/screenshot_dataset/test/"

train_yolo_path = "./screenshot_project/ultralytics//ultralytics/cfg/screenshot_yolo_dataset/train/"
valid_yolo_path = "./screenshot_project/ultralytics/ultralytics/cfg/screenshot_yolo_dataset/valid/"
test_yolo_path = "./screenshot_project/ultralytics/ultralytics/cfg/screenshot_yolo_dataset/test/"
