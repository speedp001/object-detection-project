...
model = YOLO("./flowchart_project/runs/detect/train/weights/best.pt") # load a custom model 
data_path = "./flowchart_project/ultralytics/ultralytics/cfg/flowchart_yolo_dataset/test/images"
