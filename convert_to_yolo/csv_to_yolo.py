...
train_folder_path = "./convert_to_yolo/csv_dataset/train/"
val_folder_path = "./convert_to_yolo/csv_dataset/val/"
...
def convert_to_yolo_format(annotation_df, org_image_folder, output_folder, target_size) :
    for idx, row in tqdm(annotation_df.iterrows()) :
        ...
        #bouding box info
        x_center, y_center, width, hegiht = scaled_bbox
...
def resize_and_scale_bbox(img, bbox, target_size) :
    ...
    # bounding box scale
    # csv annotation에서 bbox는 좌상단 좌표와 width, height로 표기하지만
    # yolo annotation에서 bbox는 중심좌표와 width, height로 표기한다.
...
train_yolo_folder = "./convert_to_yolo/yolo_dataset/train"
val_yolo_folder = "./convert_to_yolo/yolo_dataset/val/"
